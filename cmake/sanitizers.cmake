  ...
  if(UNIX)
    ...
    if(USE_SANITIZER MATCHES "([Aa]ddress)")
      ...
      if(SANITIZER_ADDR_AVAILABLE)
        ...
        message(FATAL_ERROR "pointer-compare sanitizer not available for ${CMAKE_CXX_COMPILER}")
      endif()
      ...
      if(SANITIZER_ADDR_AVAILABLE)
        ...
        message(FATAL_ERROR "pointer-subtract sanitizer not available for ${CMAKE_CXX_COMPILER}")
      endif()
    endif()
